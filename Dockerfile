...
RUN apt-get update && \
    ...
    php7.3-cli php7.3-curl php7.3-fpm php7.3-mbstring php7.3-pdo php7.3-mysql php7.3-xml php7.3-common php7.3-json php7.3-bcmath php7.3-ctype php7.3-tokenizer php7.3-redis && \
